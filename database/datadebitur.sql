...
CREATE TABLE `datadebitur` (
  ...
  `sbaw1` float(11) NOT NULL,
  `sbak1` float(11) NOT NULL,
  `sbp1` float(11) NOT NULL,
  `sbaw2` float(11) NOT NULL,
  `sbak2` float(11) NOT NULL,
  `sbp2` float(11) NOT NULL,
  `sbaw3` float(11) NOT NULL,
  `sbak3` float(11) NOT NULL,
  `sbp3` float(11) NOT NULL,
