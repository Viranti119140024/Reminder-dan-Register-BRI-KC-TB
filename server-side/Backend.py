...
def tambahdebitur():
 # connect
    ...
    if request.method == 'GET':
        ...
        sukubunga1 = request.form['sukubunga1']
        sukubunga2 = request.form['sukubunga2']
        sukubunga3 = request.form['sukubunga3']
        ...
        cursor.execute('''INSERT INTO datadebitur VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)''',(nama_debitur, no_rekening, jenis_kredit, baki_debet, rm, jangkawaktu, sukubunga1, sukubunga2, sukubunga3, jadwal_pokok, jadwal_jatuh_tempo, akad, keterangan))
        conn.commit()
        cursor.close()
